    ...
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="col typography">
          ...
          <p className="text-lg mb-6">
            CookSister is a place where you can please your soul and tummy with delicious food recipes of all cuisines. And our service is absolutely free. So start exploring now.
          </p>
          <Link to="/popular">
      ...
      <section className="container mx-auto px-6 py-10">
        ...
        <div className="flex items-center overflow-x-auto">
          {[
            {
              name: "Anzal Gedi, Food Enthusiast",
              image: "/images/anzal.jpg",
              rating: 5,
              comment: "CookSister is my go-to app for all my culinary adventures. The recipes are fantastic and easy to follow!",
            },
            {
              ...
              rating: 4,
              comment: "I've tried so many new dishes thanks to CookSister. The step-by-step instructions make cooking a breeze!",
            },
            {
              name: "Eve Akoko, Food Blogger",
              image: "/images/eve.jpg",
              rating: 5,
              comment: "CookSister has revolutionized my kitchen. The variety of recipes and the quality of the instructions are top-notch.",
            },
            {
              name: "Aminna Abdi, Culinary Student",
              image: "/images/aminna.jpg",
              rating: 5,
              comment: "As a culinary student, I find CookSister to be an invaluable resource. The recipes are diverse and the app is user-friendly.",
            },
            {
              name: "Sarah Abdullahi, Busy Mom",
              image: "/images/busymom.jpg",
              rating: 5,
              comment: "CookSister has saved me so much time in the kitchen. The recipes are quick, easy, and delicious!",
            },
            {
              name: "Iqra Ahmed, Chef",
              ...
              rating: 5,
              comment: "CookSister is a game-changer. The recipes are well-curated and the app design is superb!",
            }
